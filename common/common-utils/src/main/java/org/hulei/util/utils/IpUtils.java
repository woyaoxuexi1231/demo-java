 ...
 * IP 地址工具类
 * <p>
 * 提供获取客户端真实 IP 地址和构建完整请求 URL 的工具方法。
 * 支持多种代理场景下的 IP 地址获取。
 * <p>
 * <h3>功能说明：</h3>
 * <ul>
 *     <li>获取客户端真实 IP 地址（支持多种代理场景）</li>
 *     <li>构建完整的请求 URL（包含协议、域名、端口、路径、参数）</li>
 * </ul>
 * <p>
 * <h3>IP 获取优先级：</h3>
 * <ol>
 *     <li>X-Forwarded-For 请求头（多级代理场景）</li>
 *     <li>X-Real-IP 请求头（Nginx 等代理）</li>
 *     <li>Proxy-Client-IP 请求头</li>
 *     <li>WL-Proxy-Client-IP 请求头（WebLogic）</li>
 *     <li>HTTP_CLIENT_IP 请求头</li>
 *     <li>HTTP_X_FORWARDED_FOR 请求头</li>
 *     <li>getRemoteAddr() 方法（直接连接）</li>
 * </ol>
 *
 * @author hulei
 * @since 2024/10/15
