 ...
 *     <li>Repository：{@code org.hulei.jpa.repository}</li>
 * </ul>
 * <p>
 * <h3>注意事项：</h3>
 * <ul>
...
@EnableJpaRepositories(basePackages = "org.hulei.jpa.repository")
@ComponentScan(basePackages = "org.hulei.entity.jpa.pojo")
@Configuration
